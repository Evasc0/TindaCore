...
const TIERS: Array<{
...
}> = [
  {
    ...
    features: [
      ...
      { text: "Product categories", included: false },
      { text: "Analytics dashboard", included: false },
      { text: "Smart Pabili automation", included: false },
      { text: "Smart Restock", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Top / slow moving products", included: true },
      { text: "Smart Pabili (auto-add to POS)", included: true },
      { text: "Predicted low stock alerts", included: true },
      { text: "Smart Restock preview (top 3)", included: false },
      { text: "Financial reports", included: false },
    ],
  },
  {
