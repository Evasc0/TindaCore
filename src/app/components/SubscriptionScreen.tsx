...
const TIERS: Array<{
...
}> = [
  {
    ...
    features: [
      { text: "Basic POS & Barcode Scan", included: true },
      { text: "Manual Product Input", included: true },
      { text: "Basic Inventory View", included: true },
      { text: "Utang (Credit) Tracking", included: true },
      { text: "Basic Daily Sales Summary", included: true },
      { text: "Basic Pabili Notification", included: true },
      { text: "Smart Pabili Item Pre-selection", included: false },
      { text: "Smart Restock (Top 3)", included: false },
      { text: "Advanced Analytics", included: false },
      { text: "Financial Statements", included: false },
      { text: "Community Dashboard", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Smart Pabili (Unlimited)", included: true },
      { text: "Item Pre-selection by Customer", included: true },
      { text: "Multi-device Notifications", included: true },
      { text: "Smart Restock (Top 3 Items)", included: true },
      { text: "Basic Analytics & Trends", included: true },
      { text: "Fastest Moving Products", included: true },
      { text: "Predicted Low Stock Alerts", included: true },
      { text: "Limited Cloud Backup", included: true },
      { text: "Full Restock Suggestions", included: false },
      { text: "Financial Statements / P&L", included: false },
      { text: "Community Dashboard", included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { text: "Full Smart Restock All Products", included: true },
      { text: "Restock Shopping List (Auto)", included: true },
      { text: "POS Auto-Add from Pabili", included: true },
      { text: "Financial Statements / P&L", included: true },
      { text: "Advanced Sales Analytics", included: true },
      { text: "Slow Moving Products Report", included: true },
      { text: "Community Dashboard", included: true },
      { text: "Supplier Price Suggestions", included: true },
      { text: "Weekly Profit Reports", included: true },
      { text: "Full Cloud Backup & Sync", included: true },
      { text: "Payment QR (GCash/PayMaya)", included: true },
    ],
  },
];
